...
export interface TaskboardCapabilities {
  localAiChat: boolean;
  productCollaboration?: boolean;
  publicAccess?: boolean;
  publicRole?: "product" | "technical" | "admin";
  productCollaborationWrite?: boolean;
  technicalCollaborationWrite?: boolean;
  taskWrite?: boolean;
}

export type ProductSessionStatus = "discovery" | "draft" | "approved" | "handed_off";
...
export interface ProductSession {
  ...
  technicalDocumentVersion: number;
  technicalApprovedDocument: string | null;
  technicalApprovedVersion: number | null;
  technicalApprovedAt: string | null;
  technicalApprovedBy: string | null;
  technicalOwner: ActorIdentity | null;
  deliveryNote: string;
  deliverySubmittedAt: string | null;
  deliverySubmittedBy: string | null;
  implementationPr: string | null;
  testDeploymentUrl: string | null;
  testDeploymentWorkflowRun: string | null;
  testDeploymentImmutableTag: string | null;
  testDeploymentPrNumbers: number[];
  acceptanceStatus: "pending" | "accepted" | "changes_requested" | null;
  acceptanceNote: string | null;
  acceptanceAt: string | null;
  acceptanceBy: string | null;
...
export type ProductAiRun = Omit<AiChatRun, "threadId">;
